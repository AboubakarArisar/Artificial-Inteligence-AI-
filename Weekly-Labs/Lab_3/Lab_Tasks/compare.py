...
mse_deg2, mae_deg2, r2_deg2, y_pred_deg2 = fit_polynomial(2)
mse_deg3, mae_deg3, r2_deg3, y_pred_deg3 = fit_polynomial(3)

print(f"Degree 2 - MSE: {mse_deg2}, MAE: {mae_deg2}, R²: {r2_deg2}")
print(f"Degree 3 - MSE: {mse_deg3}, MAE: {mae_deg3}, R²: {r2_deg3}")
...
print(f"KNN - MSE: {mse_knn}, MAE: {mae_knn}, R²: {r2_knn}")
